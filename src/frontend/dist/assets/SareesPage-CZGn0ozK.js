...
function SareesPage() {
  ...
  const filtered = (sarees ?? []).filter((p) => {
    ...
    const matchSub = subCategory === "All" ? true : `${p.name} ${p.description}`.toLowerCase().includes(subCategory.toLowerCase());
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-56 md:h-72 overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 w-full", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-serif text-4xl md:text-5xl text-champagne-100", children: "Sarees" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-teal-200 text-sm mt-2", children: "Silk, Cotton, Banarasi & More" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-teal-50 border-b border-teal-100 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-teal-800 text-base", children: "Not sure which saree suits you?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs text-teal-500", children: "Try our AI-powered suitability checker" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Dialog, { open: tryOnOpen, onOpenChange: setTryOnOpen, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "bg-teal-700 hover:bg-teal-600 text-champagne-200 font-sans text-xs tracking-widest uppercase rounded-sm border-0 shrink-0", children: [
          "Virtual Try-On ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-2xl max-h-[90vh] overflow-y-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-serif text-teal-800", children: "Virtual Try-On" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(VirtualTryOn, { allSarees: sarees ?? [] })
        ] })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white border-b border-border sticky top-16 z-30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 items-center py-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pb-3 overflow-x-auto flex gap-2 scrollbar-hide", children: SUB_CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          "data-ocid": "sarees.subcategory.tab",
          onClick: () => setSubCategory(cat),
          className: `shrink-0 px-4 py-1.5 rounded-full text-xs font-sans font-medium border transition-all duration-150 whitespace-nowrap ${subCategory === cat ? "bg-teal-700 text-white border-teal-700 shadow-sm" : "bg-white text-teal-700 border-teal-300 hover:border-teal-500 hover:bg-teal-50"}`,
          children: cat
        },
        cat
      )) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-10 bg-sand-50", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4", children: Array.from({ length: 8 }, (_, i) => i).map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl text-teal-700 mb-2", children: "No sarees found" }),
