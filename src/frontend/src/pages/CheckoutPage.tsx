...
import gpayQR from "/assets/uploads/WhatsApp-Image-2026-03-07-at-11.19.38-AM-1-1.jpeg";
                  ...
                  {payment.type === "upi" && (
                    <div className="flex flex-col items-center gap-3 py-4">
                      <p className="text-sm text-muted-foreground text-center">
                        Scan the QR code using GPay, PhonePe, or any UPI app
                      </p>
                      <div className="border-2 border-teal-200 rounded-xl p-3 bg-white shadow-md">
                        <img
                          src={gpayQR}
                          alt="GPay QR Code"
                          width={220}
                      ...
                      <p className="font-bold text-teal-800 text-base tracking-wide">
                        pushpasanthi54@oksbi
                      </p>
